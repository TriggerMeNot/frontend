...
const ReactionNode: React.FC<NodeProps> = memo(({ data, isConnectable }) => {
  ...
  return (
    <>
      <div
        className="w-20 h-20 z-10 relative flex items-center justify-center px-4 py-2 border-dashed border-2 border-gray-900 dark:border-white rounded-xl cursor-grab bg-neutral-50 dark:bg-gray-900 text-xs"
      ...
      <p className="text-center text-xs mt-2 font-thin max-w-20">{data?.name as string}</p>
